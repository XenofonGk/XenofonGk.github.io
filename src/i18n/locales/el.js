...
export default {
  ...
  projects: {
    ...
    apiNote: 'ASP.NET Core και PostgreSQL, επαληθευμένο σε κάθε push',
    arenaNote: 'Μεταγλωττισμένο από C++ σε WebAssembly',
  ...
  demo: {
    intro: 'Ένα τρένο μπορεί να φύγει από το αμαξοστάσιο μόνο αν πληροί όλους τους κανόνες σύζευξης και φόρτωσης. Προσθέστε βαγόνια και δείτε ποιοι κανόνες τα απορρίπτουν — και σημειώστε ότι η αφαίρεση ενός βαγονιού απορρίπτεται επίσης όταν το τρένο που θα απομείνει δεν είναι ασφαλές.',
    tryThis: 'Δοκιμάστε ένα από αυτά',
    sentenceEnd: '.',
    rejectedBecause: 'Το βαγόνι τύπου {type} βάρους {weight} απορρίφθηκε — {reason}',
    removeRejectedBecause: 'Το βαγόνι {i} δεν μπορεί να αφαιρεθεί — {reason}',
    reasons: {
      none: 'έγινε αποδεκτό',
      nullTrain: 'δεν υπάρχει τρένο',
      trainFull: 'το τρένο έχει ήδη φτάσει το όριο των 50 βαγονιών',
      badType: 'δεν είναι έγκυρος τύπος βαγονιού',
      badWeight: 'ένα βαγόνι πρέπει να ζυγίζει περισσότερο από το τίποτα',
      totalWeight: 'το τρένο θα υπερέβαινε το συνολικό όριο βάρους των 20.000',
      engineOrder: 'οι ατμομηχανές πρέπει να βρίσκονται όλες μπροστά, και το φορτίο είναι ήδη συζευγμένο',
      oilFirstFreight: 'το πρώτο βαγόνι φορτίου πίσω από τις ατμομηχανές δεν επιτρέπεται να είναι πετρελαίου',
      woodOilAdjacent: 'θα έβαζε ένα βαγόνι ξυλείας δίπλα σε ένα βαγόνι πετρελαίου',
      pullCapacity: 'το φορτίο θα ζύγιζε περισσότερο από όσο μπορούν να τραβήξουν οι ατμομηχανές',
      badIndex: 'δεν υπάρχει βαγόνι σε αυτή τη θέση',
      lastEngine: 'ένα τρένο πρέπει να διατηρεί τουλάχιστον μία ατμομηχανή',
    },
    scenarios: {
      oilFirst: {
        label: 'Πετρέλαιο πρώτο',
        rejected: 'Απορρίφθηκε: {reason} Βάλτε πρώτα ένα βαγόνι τροφίμων ή ξυλείας πίσω από την ατμομηχανή, και τότε το πετρέλαιο θα επιτρέπεται.',
        accepted: 'Έγινε αποδεκτό.',
      },
      buffer: {
        label: 'Αφαίρεση του ενδιάμεσου',
        rejected: 'Αυτό είναι το ενδιαφέρον. Το τρένο είναι Ατμομηχανή, Ξυλεία, Τρόφιμα, Πετρέλαιο — το βαγόνι τροφίμων κρατά χωριστά την ξυλεία και το πετρέλαιο. Η αφαίρεσή του απορρίπτεται: {reason} Οι κανόνες είναι συμμετρικοί, άρα ό,τι δεν μπορεί να χτιστεί δεν μπορεί ούτε να αποκαλυφθεί.',
        accepted: 'Έγινε αποδεκτό.',
      },
      capacity: {
        label: 'Υπερφόρτωση ατμομηχανών',
        rejected: 'Απορρίφθηκε: {reason} Το συνολικό βάρος και η ικανότητα έλξης είναι ξεχωριστά όρια — αυτό το τρένο είναι πολύ κάτω από τις 20.000, αλλά μία ατμομηχανή μπορεί να τραβήξει μόνο 5.000.',
        accepted: 'Έγινε αποδεκτό.',
      },
      engineOrder: {
        label: 'Ατμομηχανή στο πίσω μέρος',
        rejected: 'Απορρίφθηκε: {reason} Οι ατμομηχανές μπορούν να προστεθούν μόνο όσο κάθε βαγόνι μπροστά τους είναι επίσης ατμομηχανή.',
        accepted: 'Έγινε αποδεκτό.',
      },
    },
  ...
  taskDemo: {
    ...
    placeholder: 'π.χ. Έλεγχος του pull request',
    add: 'Προσθήκη εργασίας',
    complete: 'Ολοκλήρωση',
    reopen: 'Επανάνοιγμα',
    delete: 'Διαγραφή',
    created: 'Η εργασία δημιουργήθηκε — το API επέστρεψε 201 με το location της.',
    rejected: 'Απορρίφθηκε με 400 — μια εργασία χρειάζεται τίτλο.',
    deleted: 'Διαγράφηκε — το API επέστρεψε 204.',
    waking: 'Η βάση δεδομένων ξυπνάει… κοιμάται όταν είναι αδρανής στο δωρεάν πλάνο, οπότε το πρώτο αίτημα χρειάζεται λίγο χρόνο.',
    offline: 'Το live API δεν είναι προσβάσιμο αυτή τη στιγμή, οπότε εδώ φαίνεται μια καταγεγραμμένη συνεδρία. Ο πηγαίος κώδικας και το πλήρες αρχείο αιτημάτων συνδέονται παραπάνω.',
    unhosted: 'Αυτό το API δεν είναι deployed σε δημόσιο host. Τρέχει με μία εντολή μέσω Docker Compose, και κάθε endpoint παρακάτω επαληθεύεται ξανά σε πραγματική PostgreSQL σε κάθε push — το badge στο repository δείχνει το τελευταίο αποτέλεσμα.',
    transcriptCaption: 'Καταγεγραμμένα αιτήματα προς το API και η κατάσταση που επέστρεψε καθένα',
    method: 'Μέθοδος',
    endpoint: 'Endpoint',
    status: 'Κατάσταση',
    notesTitle: 'Τι αποδεικνύει αυτό',
    notes: [
      'Κάθε αίτημα φτάνει σε μια πραγματική υπηρεσία ASP.NET Core με βάση δεδομένων PostgreSQL, όχι σε mock.',
      'Τα αιτήματα δεσμεύονται σε DTOs, οπότε ο καλών δεν μπορεί να ορίσει το id ή τον χρόνο δημιουργίας — αυτά τα διαχειρίζεται μόνο ο server.',
      'Οι κωδικοί κατάστασης είναι αυτοί που αναμένεται να επιστρέφει κάθε ρήμα: 201 με location στη δημιουργία, 400 σε μη έγκυρο σώμα, 404 για άγνωστο id, 204 σε ενημέρωση και διαγραφή.',
      'Η βάση δεδομένων μηδενίζεται όταν είναι αδρανής, οπότε το πρώτο αίτημα μετά από παύση πρέπει να την ξυπνήσει.',
    ],
  },

  arenaDemo: {
    loading: 'Φόρτωση της μεταγλωττισμένης αρένας…',
    failed: 'Η διαδραστική επίδειξη δεν φόρτωσε σε αυτό το πρόγραμμα περιήγησης. Ο πηγαίος κώδικας είναι συνδεδεμένος παραπάνω.',
    warrior: 'Πολεμιστής',
    mage: 'Μάγος',
    health: 'HP',
    level: 'Επ.',
    damage: 'Ζημ.',
    takeTurn: 'Παίξε γύρο',
    hint: 'Ανέβασε επίπεδο για μεγαλύτερη ζημιά, καλύτερη άμυνα και πρώτη κίνηση — το υψηλότερο επίπεδο χτυπά πρώτο. Μετά διάλεξε αντίπαλο.',
    defence: 'ΑΜΥ',
    opponent: 'Αντίπαλος',
    ready: 'Έτοιμο.',
    reset: 'Επαναφορά',
    finished: 'Τέλος μάχης',
    addPower: '+3 δύναμη',
    levelUp: 'Ανέβασμα επιπέδου',
    toAct: 'παίζει.',
    wins: 'κερδίζει.',
    notesTitle: 'Τι αποδεικνύει αυτό',
    notes: [
      'Ο Πολεμιστής και ο Μάγος μεταγλωττίζονται από τον C++ κώδικα του αποθετηρίου και εκτελούνται εδώ ως WebAssembly — η μάχη δεν έχει ξαναγραφτεί σε JavaScript.',
      'Η ζημιά διανέμεται μέσω της αφηρημένης βασικής κλάσης Character, οπότε ποια υποκλάση δρα καθορίζει αν αθροίζονται δεξιότητες ή μαγική ισχύς.',
      'Οι αλλαγές υγείας γίνονται μέσω του δικού της operator+= της κλάσης, και η προσθήκη ισχύος χρησιμοποιεί operator+= στον συγκεκριμένο τύπο.',
      'Οι αρχικές τιμές προέρχονται από το αρχείο ρόστερ του αποθετηρίου, οπότε μια μάχη εδώ παράγει τους ίδιους αριθμούς με το εγγενές δυαδικό αρχείο.',
    ],
  },
