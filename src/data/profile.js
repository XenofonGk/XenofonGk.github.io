...
export const profile = {
  ...
  linkedinLabel: 'linkedin.com/in/xenofongkioka',
}

/* Keys map to about.specs.<key> and about.specValues.<key> in the locales. */
export const specKeys = ['based', 'focus', 'current', 'education', 'languages', 'status']
...
export const skillGroups = [
  { key: 'languages', items: ['C#', 'TypeScript', 'JavaScript', 'PHP', 'C', 'C++'] },
  {
    key: 'frameworks',
    items: ['ASP.NET Core MVC', 'EF Core', 'React', 'Symfony', 'OroCommerce'],
  },
  { key: 'data', items: ['SQL Server', 'PostgreSQL', 'MySQL', 'Docker', 'Git'] },
  {
    key: 'practice',
    items: ['OOP Design', 'Agile / Scrum', 'Relational DB Design', 'WCAG / a11y'],
  },
]
