...
var InputNumber = React14.memo(React14.forwardRef(function(inProps, ref) {
  ...
  function countDecimals(value) {
    ...
    if (s.toLowerCase().includes("e")) {
      var _s$split = s.split("e"), _s$split2 = _slicedToArray6(_s$split, 2), mantissa = _s$split2[0], expStr = _s$split2[1];
...
var VirtualScroller = React29.memo(React29.forwardRef(function(inProps, ref) {
  ...
  var _React$useState9 = React29.useState(props.numToleratedItems), _React$useState0 = _slicedToArray7(_React$useState9, 2), numToleratedItemsState = _React$useState0[0], setNumToleratedItemsState = _React$useState0[1];
  var _React$useState1 = React29.useState(props.loading || false), _React$useState10 = _slicedToArray7(_React$useState1, 2), loadingState = _React$useState10[0], setLoadingState = _React$useState10[1];
  var _React$useState11 = React29.useState([]), _React$useState12 = _slicedToArray7(_React$useState11, 2), loaderArrState = _React$useState12[0], setLoaderArrState = _React$useState12[1];
...
var TableBody = React44.memo(React44.forwardRef(function(props, ref) {
  ...
  var createEmptyContent = function createEmptyContent2() {
    ...
    return React44.createElement("tr", emptyMessageProps, React44.createElement("td", bodyCellProps, content2));
  };
  var createGroupHeader = function createGroupHeader2(rowData, rowIndex, expanded, colSpan) {
    if (isSubheaderGrouping && shouldRenderRowGroupHeader(props.value, rowData, rowIndex - props.first)) {
      ...
      if (!options.customRendering) {
        ...
        _content = React44.createElement("td", bodyCellProps, toggler, React44.createElement("span", rowGroupHeaderNameProps, _content));
      }
      ...
      return React44.createElement("tr", rowGroupHeaderProps, _content);
    }
    return null;
  };
  ...
  var createExpansion = function createExpansion2(rowData, rowIndex, expanded, colSpan) {
    if (expanded && !(isSubheaderGrouping && props.expandableRowGroups)) {
      ...
      if (!options.customRendering) {
        ...
        _content2 = React44.createElement("td", bodyCellProps, _content2);
      }
      ...
      return React44.createElement("tr", rowExpansionProps, _content2);
    }
    return null;
  };
  var createGroupFooter = function createGroupFooter2(rowData, rowIndex, expanded, colSpan) {
    if (isSubheaderGrouping && shouldRenderRowGroupFooter(props.value, rowData, rowIndex - props.first, expanded)) {
      ...
      return React44.createElement("tr", rowGroupFooterProps, _content3);
    }
    return null;
  };
  var createContent = function createContent2() {
...
var DataTable = React44.forwardRef(function(inProps, ref) {
  ...
  var _React$useState9 = React44.useState(props.multiSortMeta), _React$useState0 = _slicedToArray10(_React$useState9, 2), multiSortMetaState = _React$useState0[0], setMultiSortMetaState = _React$useState0[1];
  var _React$useState1 = React44.useState(props.filters), _React$useState10 = _slicedToArray10(_React$useState1, 2), filtersState = _React$useState10[0], setFiltersState = _React$useState10[1];
  var _React$useState11 = React44.useState([]), _React$useState12 = _slicedToArray10(_React$useState11, 2), columnOrderState = _React$useState12[0], setColumnOrderState = _React$useState12[1];
  var _React$useState13 = React44.useState(null), _React$useState14 = _slicedToArray10(_React$useState13, 2), groupRowsSortMetaState = _React$useState14[0], setGroupRowsSortMetaState = _React$useState14[1];
  var _React$useState15 = React44.useState({}), _React$useState16 = _slicedToArray10(_React$useState15, 2), editingMetaState = _React$useState16[0], setEditingMetaState = _React$useState16[1];
  var _React$useState17 = React44.useState({}), _React$useState18 = _slicedToArray10(_React$useState17, 2), frozenEditingMetaState = _React$useState18[0], setFrozenEditingMetaState = _React$useState18[1];
  var _React$useState19 = React44.useState(props.rows), _React$useState20 = _slicedToArray10(_React$useState19, 2), d_rowsState = _React$useState20[0], setD_rowsState = _React$useState20[1];
  var _React$useState21 = React44.useState({}), _React$useState22 = _slicedToArray10(_React$useState21, 2), d_filtersState = _React$useState22[0], setD_filtersState = _React$useState22[1];
  var metaData = {
    props,
    state: {
      first: firstState,
  ...
  var restoredRef = React44.useRef(false);
